...
function _probe2df(flbed::FluidisedBed, use_slices::Bool,
    slice_dirn::String, y_agg::String)
    ...
    if use_slices
        ...
        pressure_arr = zeros(Float32, n_times, 4)
    ...
    function plot_pressure(
        flbed::FluidisedBed, x_var::String, png_name=Nothing, use_slices::Bool=true,
        slice_dirn::Char=Nothing, y_agg::String=Nothing, dump_probe0::Bool=false)
